...
export default function AboutOptions() {
	return (
		<div className={style.group} id="about">
			...
			<p className={style.description}>This extension is inspired by ChromeLL. Thanks to Pokemans, Sonicmax, Seiru, Cosban, plus all other maintainers & contributers of the years. If you contributed to ChromeLL and I missed your name, please let me know.</p>
